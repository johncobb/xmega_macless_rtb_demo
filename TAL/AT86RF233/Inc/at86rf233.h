 ...
 *
 * $Id: at86rf233.h 34170 2013-02-01 08:33:16Z sschneid $
 *
...
/** Access parameters for sub-register CPM_0 in register @ref RG_TOM_CPM_0 */
#define SR_CPM_0   0x00, 0xFF, 0

/** Access parameters for sub-register CPM_1 in register @ref RG_TOM_CPM_1 */
#define SR_CPM_1   0x01, 0xFF, 0

/** Access parameters for sub-register CPM_2 in register @ref RG_TOM_CPM_2 */
#define SR_CPM_2   0x02, 0xFF, 0

/** Access parameters for sub-register CPM_3 in register @ref RG_TOM_CPM_3 */
#define SR_CPM_3   0x03, 0xFF, 0

/** Access parameters for sub-register CPM_4 in register @ref RG_TOM_CPM_4 */
#define SR_CPM_4   0x04, 0xFF, 0

/** Access parameters for sub-register CPM_5 in register @ref RG_TOM_CPM_5 */
#define SR_CPM_5   0x05, 0xFF, 0

/** Access parameters for sub-register CPM_6 in register @ref RG_TOM_CPM_6 */
#define SR_CPM_6   0x06, 0xFF, 0

/** Access parameters for sub-register CPM_7 in register @ref RG_TOM_CPM_7 */
#define SR_CPM_7   0x07, 0xFF, 0

/** Access parameters for sub-register CPM_8 in register @ref RG_TOM_CPM_8 */
#define SR_CPM_8   0x08, 0xFF, 0
...
/** Access parameters for sub-register FEC in register @ref RG_TOM_FEC */
#define SR_FEC   0x09, 0xFF, 0
...
/** Access parameters for sub-register PEL_SHIFT_VALUE in register @ref RG_RX_CTRL */
#define SR_PEL_SHIFT_VALUE   0x0A, 0xC0, 6
...
/** Access parameters for sub-register TIM_0 in register @ref RG_TOM_TIM_0 */
#define SR_TIM_0   0x0A, 0xFF, 0

/** Access parameters for sub-register TIM_1 in register @ref RG_TOM_TIM_1 */
#define SR_TIM_1   0x0B, 0xFF, 0

/** Access parameters for sub-register TIM_2 in register @ref RG_TOM_TIM_2 */
#define SR_TIM_2   0x0C, 0xFF, 0
...
/** Constant IEEE_CHANNEL_11 for sub-register @ref SR_CHANNEL in register PHY_CC_CCA */
#define IEEE_CHANNEL_11   (0x0B)

/** Constant IEEE_CHANNEL_12 for sub-register @ref SR_CHANNEL in register PHY_CC_CCA */
#define IEEE_CHANNEL_12   (0x0C)

/** Constant IEEE_CHANNEL_13 for sub-register @ref SR_CHANNEL in register PHY_CC_CCA */
#define IEEE_CHANNEL_13   (0x0D)

/** Constant IEEE_CHANNEL_14 for sub-register @ref SR_CHANNEL in register PHY_CC_CCA */
#define IEEE_CHANNEL_14   (0x0E)

/** Constant IEEE_CHANNEL_15 for sub-register @ref SR_CHANNEL in register PHY_CC_CCA */
#define IEEE_CHANNEL_15   (0x0F)

/** Constant IEEE_CHANNEL_16 for sub-register @ref SR_CHANNEL in register PHY_CC_CCA */
#define IEEE_CHANNEL_16   (0x10)

/** Constant IEEE_CHANNEL_17 for sub-register @ref SR_CHANNEL in register PHY_CC_CCA */
#define IEEE_CHANNEL_17   (0x11)

/** Constant IEEE_CHANNEL_18 for sub-register @ref SR_CHANNEL in register PHY_CC_CCA */
#define IEEE_CHANNEL_18   (0x12)

/** Constant IEEE_CHANNEL_19 for sub-register @ref SR_CHANNEL in register PHY_CC_CCA */
#define IEEE_CHANNEL_19   (0x13)

/** Constant IEEE_CHANNEL_20 for sub-register @ref SR_CHANNEL in register PHY_CC_CCA */
#define IEEE_CHANNEL_20   (0x14)

/** Constant IEEE_CHANNEL_21 for sub-register @ref SR_CHANNEL in register PHY_CC_CCA */
#define IEEE_CHANNEL_21   (0x15)

/** Constant IEEE_CHANNEL_22 for sub-register @ref SR_CHANNEL in register PHY_CC_CCA */
#define IEEE_CHANNEL_22   (0x16)

/** Constant IEEE_CHANNEL_23 for sub-register @ref SR_CHANNEL in register PHY_CC_CCA */
#define IEEE_CHANNEL_23   (0x17)

/** Constant IEEE_CHANNEL_24 for sub-register @ref SR_CHANNEL in register PHY_CC_CCA */
#define IEEE_CHANNEL_24   (0x18)

/** Constant IEEE_CHANNEL_25 for sub-register @ref SR_CHANNEL in register PHY_CC_CCA */
#define IEEE_CHANNEL_25   (0x19)

/** Constant IEEE_CHANNEL_26 for sub-register @ref SR_CHANNEL in register PHY_CC_CCA */
#define IEEE_CHANNEL_26   (0x1A)
...
/** Constant PEL_SHIFT_EARLY for sub-register @ref SR_PEL_SHIFT_VALUE in register RX_CTRL */
#define PEL_SHIFT_EARLY   (1)

/** Constant PEL_SHIFT_LATE for sub-register @ref SR_PEL_SHIFT_VALUE in register RX_CTRL */
#define PEL_SHIFT_LATE   (2)

/** Constant PEL_SHIFT_NORMAL for sub-register @ref SR_PEL_SHIFT_VALUE in register RX_CTRL */
#define PEL_SHIFT_NORMAL   (0)

/** Constant PMU_EN_DISABLE for sub-register @ref SR_PMU_EN in register TRX_CTRL_0 */
#define PMU_EN_DISABLE   (0)

/** Constant PMU_EN_ENABLE for sub-register @ref SR_PMU_EN in register TRX_CTRL_0 */
#define PMU_EN_ENABLE   (1)
